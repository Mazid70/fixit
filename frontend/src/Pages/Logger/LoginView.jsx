...
export default function LoginView({
  ...
  return (
    <div className="h-screen  bg-[#050505] flex flex-col lg:flex-row text-white font-sans overflow-hidden">
      ...
      <div className="relative flex-1 flex flex-col justify-between p-8 sm:p-12 lg:p-16 bg-gradient-to-br from-[#0A0A0A] to-[#050505] border-b lg:border-b-0 lg:border-r border-white/5 overflow-hidden min-h-[480px] lg:min-h-screen">
        ...
        <div className="z-10">
          ...
          >
            Connect with elite service providers. Reliable, verified hands for
            every urgent residential or commercial repair.
          </p>
        </div>
        ...
        <div className="z-10 flex flex-col gap-6 mt-12">
          <div className="flex items-center gap-4">
            <div className="flex -space-x-3">
              <div className="w-10 h-10 rounded-full border-2 border-[#050505] bg-zinc-700 overflow-hidden flex items-center justify-center text-xs font-bold text-white">
                AM
              </div>
              <div className="w-10 h-10 rounded-full border-2 border-[#050505] bg-zinc-600 overflow-hidden flex items-center justify-center text-xs font-bold text-white">
                SC
              </div>
              <div className="w-10 h-10 rounded-full border-2 border-[#050505] bg-zinc-800 overflow-hidden flex items-center justify-center text-xs font-bold text-white">
                JD
              </div>
            </div>
            <p className="text-sm text-zinc-500">
              <span className="text-white font-bold">12,400+</span> Pros
              dispatched today
            </p>
          </div>
        ...
        <div className="absolute bottom-0 right-0 opacity-[0.02] pointer-events-none select-none hidden lg:block">
          <span className="text-[320px] font-black leading-none translate-y-1/4 translate-x-12 font-display">
            USER
          </span>
        </div>
      </div>
      ...
      <div
        id="login-form-panel"
        className="w-full overflow-hidden lg:w-[460px] bg-[#050505] p-8 sm:p-12 lg:p-14 flex flex-col justify-center relative"
      >
        <div className="w-full max-w-sm mx-auto space-y-8">
          ...
          <form id="login-form" onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              <label
                htmlFor="login-email"
                className="block text-xs uppercase tracking-widest text-zinc-500 font-black font-mono"
              >
                Email Address
              </label>
